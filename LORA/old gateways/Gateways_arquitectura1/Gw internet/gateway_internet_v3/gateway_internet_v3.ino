...
void RFM95_work(){
	...
	delay(30000); //espera durante 30 segundo ( deverá ser alterado a posição dos sw 5 e 6)
	...
	pinMode(LED, OUTPUT);
	digitalWrite(LED,HIGH); //mostra a indicação de que dispositivo está pronto
}
